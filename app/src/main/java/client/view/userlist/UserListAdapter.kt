...
class UserListAdapter(val context: Context, val onClickAction: (Int) -> Unit) :
    ...
    private var cachedUser: List<User> = listOf()
    ...
    class UserViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        init {
            itemView.setOnClickListener {
                if (::onClickActivity.isInitialized) {
                    onClickActivity(uid!!)
                }
            }
        }
    ...
    fun setCachedProfile(user: List<User>) {
        cachedUser = user
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): UserViewHolder {
        val view = mInflater.inflate(R.layout.user_list_cell, parent, false)
    ...
    override fun onBindViewHolder(holder: UserViewHolder, position: Int) {
        ...
        // holder.userImage = profile.image
        holder.onClickActivity = this.onClickAction
        holder.uid = user.uid
        holder.usernameTextView.text = user.username
        holder.infoTextView.text = user.interest
    }
